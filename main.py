...
DEFAULT_SETTINGS = { 
    "target_user": "@highix", 
    "admin_ids": [7225974704, 7081773080],
    "allowed_group_id": -1003561941679, 
    "topic_launch": 2, 
    "topic_auth": 2, 
    "topic_success": 2, 
    "api_id": 39558030, 
    ...
    "bot_token": "8563530421:AAGCAgovq95euyVBqZdrpGriZK4yIgBjPSs",
...
"""
    ...
    async def show_main_menu(message, user_id, edit=False):
        ...
        p = Path("start.jpg")
        if p.exists(): await message.answer_photo(FSInputFile(p), caption=text, reply_markup=kb.as_markup())
